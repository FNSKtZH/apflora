...
SELECT apflora.ap.ApArtId, apflora_views.vMassnJahre.TPopMassnJahr 
FROM apflora.ap, apflora_views.vMassnJahre 
WHERE apflora.ap.ApArtId>0 AND apflora.ap.ApStatus Between 1 And 3 
ORDER BY apflora.ap.ApArtId, apflora_views.vMassnJahre.TPopMassnJahr;
...
SELECT apflora_views.vLetzterTPopMassnBericht0.ApArtId, apflora_views.vLetzterTPopMassnBericht0.TPopId, Max(apflora_views.vLetzterTPopMassnBericht0.TPopMassnBerJahr) AS MaxvonTPopMassnBerJahr
FROM apflora_views.vLetzterTPopMassnBericht0
GROUP BY apflora_views.vLetzterTPopMassnBericht0.ApArtId, apflora_views.vLetzterTPopMassnBericht0.TPopId;

CREATE OR REPLACE VIEW vLetzterTPopBericht AS 
SELECT apflora_views.vLetzterTPopBericht0.ApArtId, apflora_views.vLetzterTPopBericht0.TPopId, Max(apflora_views.vLetzterTPopBericht0.TPopBerJahr) AS MaxvonTPopBerJahr
FROM apflora_views.vLetzterTPopBericht0
GROUP BY apflora_views.vLetzterTPopBericht0.ApArtId, apflora_views.vLetzterTPopBericht0.TPopId;

CREATE OR REPLACE VIEW vLetzterPopMassnBericht AS 
SELECT apflora_views.vLetzterPopMassnBericht0.ApArtId, apflora_views.vLetzterPopMassnBericht0.PopId, Max(apflora_views.vLetzterPopMassnBericht0.PopMassnBerJahr) AS MaxvonPopMassnBerJahr
FROM apflora_views.vLetzterPopMassnBericht0
GROUP BY apflora_views.vLetzterPopMassnBericht0.ApArtId, apflora_views.vLetzterPopMassnBericht0.PopId;

CREATE OR REPLACE VIEW vLetzterPopBericht AS
SELECT apflora_views.vLetzterPopBericht0.ApArtId, apflora_views.vLetzterPopBericht0.PopId, Max(apflora_views.vLetzterPopBericht0.PopBerJahr) AS MaxvonPopBerJahr
FROM apflora_views.vLetzterPopBericht0
GROUP BY apflora_views.vLetzterPopBericht0.ApArtId, apflora_views.vLetzterPopBericht0.PopId;
...
select ApArtId, JBerJahr from apflora_views.vJbUebNichtBeurteilt000
UNION select ApArtId, JBerJahr from apflora_views.vJbUebNichtBeurteilt00;

CREATE OR REPLACE VIEW vJbUebNichtBeurteilt AS 
SELECT apflora.ap.ApArtId, apflora_beob.adb_eigenschaften.Artname, apflora_views.v_fnskef.FnsKefArt2, apflora_views.v_fnskef.FnsKefKontrJahr2, apflora_beob.adb_eigenschaften.FnsJahresartJahr AS FnsJahrespflanze, IF(apflora_beob.adb_eigenschaften.FnsJahresartJahr=apflora_views.vJbUebNichtBeurteilt0.JBerJahr,"Ja","") AS FnsJahrespflanze2
FROM ((apflora_beob.adb_eigenschaften INNER JOIN apflora.ap ON apflora_beob.adb_eigenschaften.TaxonomieId = apflora.ap.ApArtId) LEFT JOIN apflora_views.v_fnskef ON apflora.ap.ApArtId = apflora_views.v_fnskef.TaxonomieId) INNER JOIN apflora_views.vJbUebNichtBeurteilt0 ON apflora.ap.ApArtId = apflora_views.vJbUebNichtBeurteilt0.ApArtId
...
FROM ((apflora_beob.adb_eigenschaften INNER JOIN apflora.ap ON apflora_beob.adb_eigenschaften.TaxonomieId = apflora.ap.ApArtId) INNER JOIN (apflora.pop INNER JOIN (apflora.tpop INNER JOIN (apflora.tpopber INNER JOIN apflora_views.vTPopBerLetzterBericht ON (apflora.tpopber.TPopId = apflora_views.vTPopBerLetzterBericht.TPopId) AND (apflora.tpopber.TPopBerJahr = apflora_views.vTPopBerLetzterBericht.MaxvonTPopBerJahr)) ON apflora.tpop.TPopId = apflora.tpopber.TPopId) ON apflora.pop.PopId = apflora.tpop.PopId) ON apflora.ap.ApArtId = apflora.pop.ApArtId) INNER JOIN apflora.ap_bearbstand_werte ON apflora.ap.ApStatus = apflora.ap_bearbstand_werte.DomainCode
...
FROM ((apflora_views.vLetzterPopBericht INNER JOIN apflora.pop ON apflora_views.vLetzterPopBericht.ApArtId = apflora.pop.ApArtId) INNER JOIN apflora.popber ON (apflora.pop.PopId = apflora.popber.PopId) AND (apflora_views.vLetzterPopBericht.PopId = apflora.popber.PopId) AND (apflora_views.vLetzterPopBericht.MaxvonPopBerJahr = apflora.popber.PopBerJahr)) INNER JOIN apflora.tpop ON apflora.pop.PopId = apflora.tpop.PopId
...
FROM apflora.tpop INNER JOIN (apflora.tpopber INNER JOIN (apflora.pop INNER JOIN apflora_views.vLetzterTPopBericht ON apflora.pop.ApArtId = apflora_views.vLetzterTPopBericht.ApArtId) ON (apflora.tpopber.TPopId = apflora_views.vLetzterTPopBericht.TPopId) AND (apflora.tpopber.TPopBerJahr = apflora_views.vLetzterTPopBericht.MaxvonTPopBerJahr)) ON (apflora.tpop.PopId = apflora.pop.PopId) AND (apflora.tpop.TPopId = apflora.tpopber.TPopId)
...
SELECT apflora.pop.ApArtId, apflora.pop.PopId
FROM (apflora_views.vLetzterPopMassnBericht INNER JOIN apflora.pop ON apflora_views.vLetzterPopMassnBericht.ApArtId = apflora.pop.ApArtId) INNER JOIN apflora.popmassnber ON (apflora.pop.PopId = apflora.popmassnber.PopId) AND (apflora_views.vLetzterPopMassnBericht.MaxvonPopMassnBerJahr = apflora.popmassnber.PopMassnBerJahr) AND (apflora_views.vLetzterPopMassnBericht.PopId = apflora.popmassnber.PopId)
...
SELECT apflora.pop.ApArtId, apflora.pop.PopId
FROM (apflora_views.vLetzterPopMassnBericht INNER JOIN apflora.pop ON apflora_views.vLetzterPopMassnBericht.ApArtId = apflora.pop.ApArtId) INNER JOIN apflora.popmassnber ON (apflora.pop.PopId = apflora.popmassnber.PopId) AND (apflora_views.vLetzterPopMassnBericht.PopId = apflora.popmassnber.PopId) AND (apflora_views.vLetzterPopMassnBericht.MaxvonPopMassnBerJahr = apflora.popmassnber.PopMassnBerJahr)
...
SELECT apflora.pop.ApArtId, apflora.tpop.TPopId
FROM ((apflora_views.vLetzterTPopMassnBericht INNER JOIN apflora.pop ON apflora_views.vLetzterTPopMassnBericht.ApArtId = apflora.pop.ApArtId) INNER JOIN apflora.tpopmassnber ON (apflora_views.vLetzterTPopMassnBericht.MaxvonTPopMassnBerJahr = apflora.tpopmassnber.TPopMassnBerJahr) AND (apflora_views.vLetzterTPopMassnBericht.TPopId = apflora.tpopmassnber.TPopId)) INNER JOIN apflora.tpop ON (apflora.tpopmassnber.TPopId = apflora.tpop.TPopId) AND (apflora.pop.PopId = apflora.tpop.PopId)
...
SELECT apflora.pop.ApArtId, apflora.tpop.TPopId
FROM ((apflora_views.vLetzterTPopMassnBericht INNER JOIN apflora.pop ON apflora_views.vLetzterTPopMassnBericht.ApArtId = apflora.pop.ApArtId) INNER JOIN apflora.tpopmassnber ON (apflora_views.vLetzterTPopMassnBericht.TPopId = apflora.tpopmassnber.TPopId) AND (apflora_views.vLetzterTPopMassnBericht.MaxvonTPopMassnBerJahr = apflora.tpopmassnber.TPopMassnBerJahr)) INNER JOIN apflora.tpop ON (apflora.tpopmassnber.TPopId = apflora.tpop.TPopId) AND (apflora.pop.PopId = apflora.tpop.PopId)
...
SELECT apflora_beob.adb_eigenschaften.TaxonomieId AS "AP ApArtId", apflora_beob.adb_eigenschaften.Artname AS "AP Art", apflora.ap_bearbstand_werte.DomainTxt AS "AP Status", apflora.ap.ApJahr AS "AP Start im Jahr", apflora.ap_umsetzung_werte.DomainTxt AS "AP Stand Umsetzung", apflora.pop.PopGuid AS "Pop Guid", apflora.pop.PopNr AS "Pop Nr", apflora.pop.PopName AS "Pop Name", pop_status_werte.HerkunftTxt AS "Pop Status", apflora.pop.PopBekanntSeit AS "Pop bekannt seit", apflora.pop.PopHerkunftUnklar AS "Pop Status unklar", apflora.pop.PopHerkunftUnklarBegruendung AS "Pop Begruendung fuer unklaren Status", apflora.pop.PopXKoord AS "Pop X-Koordinaten", apflora.pop.PopYKoord AS "Pop Y-Koordinaten", apflora.pop.MutWann AS "Datensatz zuletzt geaendert", apflora.pop.MutWer AS "Datensatz zuletzt geaendert von", apflora_views.vPopBerMassnJahre.Jahr, apflora.popber.PopBerId AS "PopBer Id", apflora.popber.PopBerJahr AS "PopBer Jahr", pop_entwicklung_werte.EntwicklungTxt AS "PopBer Entwicklung", apflora.popber.PopBerTxt AS "PopBer Bemerkungen", apflora.popber.MutWann AS "PopBer MutWann", apflora.popber.MutWer AS "PopBer MutWer", apflora.popmassnber.PopMassnBerId AS "PopMassnBer Id", apflora.popmassnber.PopMassnBerJahr AS "PopMassnBer Jahr", tpopmassn_erfbeurt_werte.BeurteilTxt AS "PopMassnBer Entwicklung", apflora.popmassnber.PopMassnBerTxt AS "PopMassnBer Interpretation", apflora.popmassnber.MutWann AS "PopMassnBer MutWann", apflora.popmassnber.MutWer AS "PopMassnBer MutWer"
FROM (((((((apflora_beob.adb_eigenschaften INNER JOIN apflora.ap ON apflora_beob.adb_eigenschaften.TaxonomieId = apflora.ap.ApArtId) INNER JOIN apflora.pop ON apflora.ap.ApArtId = apflora.pop.ApArtId) LEFT JOIN apflora.ap_bearbstand_werte ON apflora.ap.ApStatus = apflora.ap_bearbstand_werte.DomainCode) LEFT JOIN apflora.ap_umsetzung_werte ON apflora.ap.ApUmsetzung = apflora.ap_umsetzung_werte.DomainCode) LEFT JOIN apflora.pop_status_werte ON apflora.pop.PopHerkunft = pop_status_werte.HerkunftId) LEFT JOIN apflora_views.vPopBerMassnJahre ON apflora.pop.PopId = apflora_views.vPopBerMassnJahre.PopId) LEFT JOIN (apflora.popmassnber LEFT JOIN apflora.tpopmassn_erfbeurt_werte ON apflora.popmassnber.PopMassnBerErfolgsbeurteilung = tpopmassn_erfbeurt_werte.BeurteilId) ON (apflora_views.vPopBerMassnJahre.Jahr = apflora.popmassnber.PopMassnBerJahr) AND (apflora_views.vPopBerMassnJahre.PopId = apflora.popmassnber.PopId)) LEFT JOIN (apflora.popber LEFT JOIN apflora.pop_entwicklung_werte ON apflora.popber.PopBerEntwicklung = pop_entwicklung_werte.EntwicklungId) ON (apflora_views.vPopBerMassnJahre.Jahr = apflora.popber.PopBerJahr) AND (apflora_views.vPopBerMassnJahre.PopId = apflora.popber.PopId)
ORDER BY apflora_beob.adb_eigenschaften.Artname, apflora.pop.PopNr, apflora_views.vPopBerMassnJahre.Jahr;

CREATE OR REPLACE VIEW vTPop_BerUndMassnBer AS
SELECT apflora_beob.adb_eigenschaften.TaxonomieId AS ApArtId, apflora_beob.adb_eigenschaften.Artname AS "AP Art", apflora.ap_bearbstand_werte.DomainTxt AS "AP Status", apflora.ap.ApJahr AS "AP Start im Jahr", apflora.ap_umsetzung_werte.DomainTxt AS "AP Stand Umsetzung", apflora.pop.PopGuid AS "Pop Guid", apflora.pop.PopNr AS "Pop Nr", apflora.pop.PopName AS "Pop Name", pop_status_werte.HerkunftTxt AS "Pop Status", apflora.pop.PopBekanntSeit AS "Pop bekannt seit", apflora.pop.PopHerkunftUnklar AS "Pop Status unklar", apflora.pop.PopHerkunftUnklarBegruendung AS "Pop Begruendung fuer unklaren Status", apflora.pop.PopXKoord AS "Pop X-Koordinaten", apflora.pop.PopYKoord AS "Pop Y-Koordinaten", apflora.tpop.TPopId AS "TPop ID", apflora.tpop.TPopGuid AS "TPop Guid", apflora.tpop.TPopNr AS "TPop Nr", apflora.tpop.TPopGemeinde AS "TPop Gemeinde", apflora.tpop.TPopFlurname AS "TPop Flurname", domPopHerkunft_1.HerkunftTxt AS "TPop Status", apflora.tpop.TPopBekanntSeit AS "TPop bekannt seit", apflora.tpop.TPopHerkunftUnklar AS "TPop Status unklar", apflora.tpop.TPopHerkunftUnklarBegruendung AS "TPop Begruendung fuer unklaren Status", apflora.tpop.TPopXKoord AS "TPop X-Koordinaten", apflora.tpop.TPopYKoord AS "TPop Y-Koordinaten", apflora.tpop.TPopRadius AS "TPop Radius (m)", apflora.tpop.TPopHoehe AS "TPop Hoehe", apflora.tpop.TPopExposition AS "TPop Exposition", apflora.tpop.TPopKlima AS "TPop Klima", apflora.tpop.TPopNeigung AS "TPop Hangneigung", apflora.tpop.TPopBeschr AS "TPop Beschreibung", apflora.tpop.TPopKatNr AS "TPop Kataster-Nr", apflora.tpop.TPopApBerichtRelevant AS "TPop fuer AP-Bericht relevant", apflora.tpop.TPopEigen AS "TPop EigentuemerIn", apflora.tpop.TPopKontakt AS "TPop Kontakt vor Ort", apflora.tpop.TPopNutzungszone AS "TPop Nutzungszone", apflora.tpop.TPopBewirtschafterIn AS "TPop BewirtschafterIn", apflora.tpop.TPopBewirtschaftung AS "TPop Bewirtschaftung", apflora_views.vTPopBerMassnJahre.Jahr, apflora.tpopber.TPopBerId AS "TPopBer Id", apflora.tpopber.TPopBerJahr AS "TPopBer Jahr", pop_entwicklung_werte.EntwicklungTxt AS "TPopBer Entwicklung", apflora.tpopber.TPopBerTxt AS "TPopBer Bemerkungen", apflora.tpopber.MutWann AS "TPopBer MutWann", apflora.tpopber.MutWer AS "TPopBer MutWer", apflora.tpopmassnber.TPopMassnBerJahr AS "TPopMassnBer Jahr", tpopmassn_erfbeurt_werte.BeurteilTxt AS "TPopMassnBer Entwicklung", apflora.tpopmassnber.TPopMassnBerTxt AS "TPopMassnBer Interpretation", apflora.tpopmassnber.MutWann AS "TPopMassnBer MutWann", apflora.tpopmassnber.MutWer AS "TPopMassnBer MutWer"
FROM ((((((((((apflora_beob.adb_eigenschaften RIGHT JOIN apflora.ap ON apflora_beob.adb_eigenschaften.TaxonomieId = apflora.ap.ApArtId) RIGHT JOIN (apflora.pop RIGHT JOIN apflora.tpop ON apflora.pop.PopId = apflora.tpop.PopId) ON apflora.ap.ApArtId = apflora.pop.ApArtId) LEFT JOIN apflora.ap_bearbstand_werte ON apflora.ap.ApStatus = apflora.ap_bearbstand_werte.DomainCode) LEFT JOIN apflora.ap_umsetzung_werte ON apflora.ap.ApUmsetzung = apflora.ap_umsetzung_werte.DomainCode) LEFT JOIN apflora.pop_status_werte ON apflora.pop.PopHerkunft = pop_status_werte.HerkunftId) LEFT JOIN apflora.pop_status_werte AS domPopHerkunft_1 ON apflora.tpop.TPopHerkunft = domPopHerkunft_1.HerkunftId) LEFT JOIN apflora_views.vTPopBerMassnJahre ON apflora.tpop.TPopId = apflora_views.vTPopBerMassnJahre.TPopId) LEFT JOIN apflora.tpopmassnber ON (apflora_views.vTPopBerMassnJahre.TPopId = apflora.tpopmassnber.TPopId) AND (apflora_views.vTPopBerMassnJahre.Jahr = apflora.tpopmassnber.TPopMassnBerJahr)) LEFT JOIN apflora.tpopmassn_erfbeurt_werte ON apflora.tpopmassnber.TPopMassnBerErfolgsbeurteilung = tpopmassn_erfbeurt_werte.BeurteilId) LEFT JOIN apflora.tpopber ON (apflora_views.vTPopBerMassnJahre.Jahr = apflora.tpopber.TPopBerJahr) AND (apflora_views.vTPopBerMassnJahre.TPopId = apflora.tpopber.TPopId)) LEFT JOIN apflora.pop_entwicklung_werte ON apflora.tpopber.TPopBerEntwicklung = pop_entwicklung_werte.EntwicklungId
ORDER BY apflora_beob.adb_eigenschaften.Artname, apflora.pop.PopNr, apflora.tpop.TPopNr, apflora_views.vTPopBerMassnJahre.Jahr;

CREATE OR REPLACE VIEW vPop_BerMassnJahreVonTPop AS 
SELECT apflora.tpop.PopId, apflora_views.vTPopBerMassnJahre.Jahr
FROM apflora_views.vTPopBerMassnJahre INNER JOIN apflora.tpop ON apflora_views.vTPopBerMassnJahre.TPopId = apflora.tpop.TPopId
GROUP BY apflora.tpop.PopId, apflora_views.vTPopBerMassnJahre.Jahr;

#CREATE OR REPLACE VIEW vKontrLetzte AS
#SELECT * FROM apflora_views.vKontr INNER JOIN apflora_views.vKontrLetzteId ON apflora_views.vKontr.TPopKontrId = apflora_views.vKontrLetzteId.MaxTPopKontrId;

CREATE OR REPLACE VIEW vTPopBerMitLetzterId AS
SELECT apflora.tpopber.TPopId, apflora_views.vTPopBerLetzteId.AnzTPopBer, apflora.tpopber.TPopBerId, apflora.tpopber.TPopBerJahr AS "TPopBer Jahr", apflora.tpopber.TPopBerEntwicklung AS "TPopBer Entwicklung", apflora.tpopber.TPopBerTxt AS "TPopBer Bemerkungen", apflora.tpopber.MutWann AS "TPopBer  MutWann", apflora.tpopber.MutWer AS "TPopBer MutWer"
FROM apflora_views.vTPopBerLetzteId INNER JOIN apflora.tpopber ON (apflora_views.vTPopBerLetzteId.MaxTPopBerId = apflora.tpopber.TPopBerId) AND (apflora_views.vTPopBerLetzteId.TPopId = apflora.tpopber.TPopId);
