...
module.exports = function (aktiverNode, parentNode, nodeZielId) {
  $.ajax({
    type: 'post',
    url: getApiHost() + '/api/v1/insert/apflora/tabelle=zielber/feld=ZielId/wert=' + erstelleIdAusDomAttributId(nodeZielId) + '/user=' + encodeURIComponent(window.sessionStorage.user)
  }).done(function (id) {
