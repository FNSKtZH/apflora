...
module.exports = function (aktiverNode, parentNode, nodePopId) {
  $.ajax({
    type: 'post',
    url: 'api/v1/insert/apflora/tabelle=popmassnber/feld=PopId/wert=' + erstelleIdAusDomAttributId($(aktiverNode).attr('id')) + '/user=' + encodeURIComponent(window.sessionStorage.user)
  }).done(function (id) {
