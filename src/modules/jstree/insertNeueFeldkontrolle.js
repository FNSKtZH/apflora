...
module.exports = function (aktiverNode, parentNode, nodeTpopId) {
  $.ajax({
    type: 'post',
    url: 'api/v1/insert/feldkontr/tpopId=' + erstelleIdAusDomAttributId(nodeTpopId) + '/tpopKontrtyp=tpopfeldkontr/user=' + encodeURIComponent(window.sessionStorage.user)
  }).done(function (id) {
